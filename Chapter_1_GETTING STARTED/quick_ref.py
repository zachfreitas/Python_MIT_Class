...
d.values() returns a view of the values in d. k in d returns True if key k is in d. 
...
del d[k] removes element with key k from d. Raises KeyError if k is not in d. for k in d iterates over the keys in d. 
